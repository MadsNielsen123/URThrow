...
int main(int argc, char* argv[])
{
    ...
    std::vector<double> joint_start_rad = {0, -1.1146, -2.2844, -0.5285, 1.571, 0};
    ...
    for (unsigned int i=0; i<63; i++)
    {
        ...
        //speed=q⁰/(f*t), f: frequency(125Hz), t: 0.5s closest so far...
        joint_speed[1] -= 2.215/63;
        joint_speed[2] += 3.773/63;
        joint_speed[3] -= 1.558/63;
